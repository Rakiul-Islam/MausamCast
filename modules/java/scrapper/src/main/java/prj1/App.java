...
public class App{
    ...
    static void get_location() throws IOException, GeoIp2Exception{
        String ip = "";
        ...
        // WebServiceClient client = new WebServiceClient.Builder(904183, "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").build();
